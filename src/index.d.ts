 ...
 * This code is from https://gist.github.com/christopher-caldwell/3876f73632872b93aacad52301810852.
 */
...
declare module "@uphold/uphold-sdk-javascript" {
  ...
  class SDK {
    ...
    setToken: (token: { access_token: string; refresh_token?: string }) => Promise<void>;
    ...
    getCardAddresses: (cardId: string, options?: ApiOptions) => Promise<CardAddress[]>;
    /** Cancels a transaction that has not yet been redeemed. */
    cancelCardTransaction: (cardId: string, transactionId: string, options?: ApiOptions) => Promise<TransactionObject>;
    ...
    getCardTransactions: (cardId: string, page?: number, itemsPerPage?: number, options?: ApiOptions) => Promise<Paginator<TransactionObject>>;
    /** Triggers a reminder for a transaction that hasn’t yet been redeemed. */
    resendCardTransaction: (cardId: string, transactionId: string, options?: ApiOptions) => Promise<TransactionObject>;
    /** Creates a card. */
    createCard: (currency: string, label: string, options?: ApiOptions) => Promise<Card>;
    /** Retrieves a card's details. */
    getCard: (cardId: string, options?: ApiOptions) => Promise<Card>;
    getCards: (page?: number, itemsPerPage?: number, options?: PaginationOptions) => Promise<Paginator<Card>>;
    /** Updates a card.
     * @note Requires the cards:write scope for Uphold Connect applications.
     */
    updateCard: (cardId: string, label: string, options?: ApiOptions) => Promise<Card>;
    /** Creates a contact */
    createContact: (requestBody: ContactMutationPayload, options?: ApiOptions) => Promise<Contact>;
    ...
    updateContact: (contactId: string, body: ContactMutationPayload, options?: ApiOptions) => Promise<Contact>;
    /** Creates a document. */
    createDocument: (type: string, value: string, options?: ApiOptions) => Promise<Document>;
    ...
    getReserveTransactions: (page?: number, itemsPerPage?: number, options?: PaginationOptions) => Promise<Paginator<TransactionObject>>;
    /** Retrieves a public transaction's details. */
    getReserveTransaction: (transactionId: string, options?: ApiOptions) => Promise<TransactionObject>;
    ...
    getReserveLedger: (page?: number, itemsPerPage?: number, options?: PaginationOptions) => Promise<Paginator<LedgerEntry>>;
    ...
    getTransaction: (transactionId: string, options?: ApiOptions) => Promise<TransactionObject>;
    /** Retrieves the transactions list of the authenticated user. */
    getTransactions: (page?: number, itemsPerPage?: number, options?: PaginationOptions) => Promise<Paginator<TransactionObject>>;
    /** Returns the details of the authenticated user. */
    getMe: (options?: ApiOptions) => Promise<User>;
    /** Updates the authenticated user's details.
     *
     * The otp argument will add the OTP-TOKEN header to the request. */
    updateMe: (body: UpdateMePayload, otp: string, options?: ApiOptions) => Promise<User>;
  }
  ...
  export class Paginator<TData> {
    ...
    getPreviousPage: (options?: ApiOptions) => Promise<Paginator<TData> | undefined>;
     ...
     */
    getPage: (page?: number, options?: ApiOptions) => Promise<Paginator<TData> | undefined>;
  }
  ...
  export class Client {
     ...
     */
    request: <TData>(url: string, method: HttpMethod, body: Record<string, unknown>, headers: Record<string, string>) => Promise<TData>;
  }
  ...
  export class OAuthClient {
    ...
    buildAccessTokenRequestByAuthorizationCodeGrant: (code: string) => RequestBody;
